...
import 'package:movie_verse/Features/Home/presentation/View_Model/Home_View_View_modal/Get%20Upcoming%20movie/get_upcoming_movie_cubit.dart';

import 'package:movie_verse/Features/Home/presentation/Views/Home%20View/Widgets/CustomListViewNowPlayingItems.dart';
import 'package:movie_verse/Features/Home/presentation/Views/Home%20View/Widgets/CustomListViewUpcomingItems%20.dart';

class CustomTopicNameUpcomingItem extends StatelessWidget {
  const CustomTopicNameUpcomingItem({super.key, required this.titlename});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        BlocProvider(
          create: (context) =>
              GetUpcomingMovieCubit(HomeRepoImpl(ApiClass(Dio())))
                ..getUpcomingMovie(),
          child: CustomListViewUpcomingItems(),
        ),
      ],
    );
  }
