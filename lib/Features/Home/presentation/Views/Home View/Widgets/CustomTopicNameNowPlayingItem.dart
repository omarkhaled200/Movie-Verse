...
class CustomTopicNameNowPlayingItem extends StatelessWidget {
  const CustomTopicNameNowPlayingItem({super.key, required this.titlename});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        BlocProvider(
          create: (context) =>
              GetNowPlayingMovieCubit(HomeRepoImpl(ApiClass(Dio())))
                ..getNowPlayingMovie(),
          child: CustomListViewNowPlayingItems(),
        ),
      ],
    );
  }
