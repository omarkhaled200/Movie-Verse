...
class CustomListViewUpcomingItems extends StatelessWidget {
  const CustomListViewUpcomingItems({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<GetUpcomingMovieCubit, GetUpcomingMovieState>(
      builder: (context, state) {
        if (state is GetUpcomingMovieSuccess) {
          return SizedBox(
        ...
        } else if (state is GetUpcomingMovieFailure) {
