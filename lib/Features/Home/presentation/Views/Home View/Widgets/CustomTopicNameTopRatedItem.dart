...
import 'package:movie_verse/Features/Home/presentation/View_Model/Home_View_View_modal/Get%20Top%20Rated%20Movie/get_top_rated_movie_cubit.dart';
...
import 'package:movie_verse/Features/Home/presentation/Views/Home%20View/Widgets/CustomListViewTopRatedItems.dart';

class CustomTopicNameTopRatedItem extends StatelessWidget {
  const CustomTopicNameTopRatedItem({super.key, required this.titlename});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        BlocProvider(
          create: (context) =>
              GetTopRatedMovieCubit(HomeRepoImpl(ApiClass(Dio())))
                ..getTopRatedMovie(),
          child: CustomListViewTopRatedItems(),
        ),
      ],
    );
  }
