...
class CustomListViewTopRatedItems extends StatelessWidget {
  const CustomListViewTopRatedItems({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<GetTopRatedMovieCubit, GetTopRatedMovieState>(
      builder: (context, state) {
        if (state is GetTopRatedMovieSuccess) {
          return SizedBox(
        ...
        } else if (state is GetTopRatedMovieFailure) {
